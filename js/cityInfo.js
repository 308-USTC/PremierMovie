...
var mMapPlace = 
[
	{"name":"北京市", "log":"116.46", "lat":"39.92", "children":[
	...
	{"name":"上海市", "log":"121.48", "lat":"31.22", "children":[
		{"name":"上海", "log":"121.48", "lat":"31.22"},
		{"name":"嘉定", "log":"121.24", "lat":"31.4"},
		{"name":"宝山", "log":"121.48", "lat":"31.41"},
		{"name":"川沙", "log":"121.7", "lat":"31.19"},
		{"name":"南汇", "log":"121.76", "lat":"31.05"},
		{"name":"奉贤", "log":"121.46", "lat":"30.92"},
		{"name":"松江", "log":"121.24", "lat":"31"},
		{"name":"金山", "log":"121.16", "lat":"30.89"},
		{"name":"青浦", "log":"121.1", "lat":"31.15"},
		{"name":"崇明", "log":"121.4", "lat":"31.73"}
	]},
	{"name":"天津市", "log":"117.2", "lat":"39.13", "children":[
	...
	{"name":"重庆市", "log":"106.54", "lat":"29.59", "children":[
		{"name":"重庆", "log":"106.54", "lat":"29.59"},
		{"name":"綦江", "log":"106.56", "lat":"29.41"},
		{"name":"长寿", "log":"106.64", "lat":"29.01"},
		{"name":"南桐", "log":"107.04", "lat":"29.86"},
		{"name":"合川", "log":"106.28", "lat":"29.26"},
		{"name":"潼南", "log":"106.22", "lat":"30.03"},
		{"name":"铜梁", "log":"105.8", "lat":"30.16"},
		{"name":"壁山", "log":"106.03", "lat":"29.86"},
		{"name":"荣昌", "log":"106.21", "lat":"29.62"},
		{"name":"大足", "log":"105.59", "lat":"29.4"},
		{"name":"永川", "log":"105.71", "lat":"29.75"},
		{"name":"万盛", "log":"105.91", "lat":"29.38"}
	]},
	{"name":"河北省", "log":"114.48", "lat":"38.03", "children":[
		{"name":"石家庄", "log":"114.48", "lat":"38.03"},
		{"name":"唐山", "log":"118.02", "lat":"39.63"},
		{"name":"行唐", "log":"114.54", "lat":"38.42"},
		{"name":"灵寿", "log":"114.38", "lat":"38.31"},
		{"name":"束鹿", "log":"115.18", "lat":"37.94"},
		{"name":"晋县", "log":"115.03", "lat":"38.03"},
		{"name":"藁城", "log":"114.84", "lat":"38.03"},
	...
	{"name":"山东省", "log":"106.54", "lat":"29.59", "children":[
	...
	{"name":"广西壮族自治区", "log":"106.54", "lat":"29.59", "children":[
...
//全国省会，直辖市，自治区名称
var provinceName = ["北京市","上海市","天津市","重庆市","河北","山西","辽宁","吉林","河南","江苏","浙江","安徽","福建","江西","山东","湖北","湖南","广东","海南","四川","贵州","云南","陕西","甘肃","青海","黑龙江","内蒙古","广西","西藏","宁夏","新疆","台湾","香港","澳门","其它"]; 
...
function getProvince(city){
    for(var i = 1; i <= provinceName.length; ++i){
        if($.inArray(city+'市', eval('city'+i)) !== -1){//判断当前城市是否在某数组中
            return provinceName[i-1];
        }
    }
}
