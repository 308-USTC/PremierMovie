 ...
 var infor = {"content":[{"name":"name","value":"勇士"},{"name":"导演","value":"加文·欧康诺,"},{"name":"编剧","value":"加文·欧康诺,Anthony Tambakis,"},{"name":"主演","value":"汤姆·哈迪,乔尔·埃哲顿,尼克·诺特,詹妮弗·莫里森,弗兰克·格里罗,凯文·杜恩,"},{"name":"类型","value":"剧情,家庭,运动,"},{"name":"上映日期","value":"2011-09-09(美国),"},{"name":"summary","value":"这是一个破碎的家庭，酗酒的教练父亲帕迪（尼克·诺特 Nick Nolte 饰）家暴妻子，次子汤米（汤姆·哈迪 Tom Hardy 饰）与不堪忍受的母亲远赴他乡；长子布兰登（乔尔·埃哲顿 Joel Edgerton 饰）为了爱情选择留下，并认为从此可以得到父亲的器重与栽培，然而最后父子还是分道扬镳。时隔多年后，汤米带着母亲痛苦死去的悲伤记忆，以及在伊战中的惨痛经历找到父亲，要求后者再度担任自己的教练，以参加MMA的重奖大赛；几乎与此同时，昔日的职业格斗选手、如今的中学物理教师布兰登为金钱所困扰，他不能忍受自己无法为妻女提供庇护，决定重返赛场。在MMA的赛场上，这对分离多年的兄弟将再度聚首，用血与汗的交融，化释彼此的心结……"},{"name":"评分","value":8.9},{"name":"image","value":"https://img5.doubanio.com/view/movie_poster_cover/lpst/public/p1145536386.jpg"},{"name":"id","value":"3217169"}]}
    ...
    var bar_stack_option = {
        ...
        series: [{
            ...
            type: 'line',
            yAxisIndex: 2,
            data: [8760,14252,9296,12297,13123,7551,12119,6547,7398,36545,19257,10704,9888,17121,16376,11117,19200,10609,9880,24324,18023,10807,15214,17805,8923,14961,7812,14546,7797,7312,6945,7184,6934,7244,7144,14694,9520,14174,8974,10939,16859]
        }, ]
    };
