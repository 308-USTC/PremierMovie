 ...
 var infor = {"content":[{"name":"name","value":"刺客信条"},{"name":"导演","value":"贾斯汀·库泽尔 "},{"name":"编剧","value":"比尔·科拉奇"},{"name":"主演","value":null},{"name":"类型","value":"动作,科幻,历史,冒险,"},{"name":"上映日期","value":"2017-02-24(中国大陆)"},{"name":"summary","value":"卡勒姆·林奇（迈克尔·法斯宾德 饰）在死刑即将执行之前清醒过来，发现他被索菲娅（玛丽昂·歌迪亚 饰）选中，来参加一个能让人类摆脱暴力冲动的计划。虚拟现实机器Animus能让用户体验祖先的记忆，被绑在机器上之后，卡勒姆·林奇意识到他是生活在西班牙宗教法庭时期一位刺客阿圭拉的后裔，他们寻找的是可以控制自由意志的伊甸园苹果。索菲娅在父亲艾伦（杰瑞米·艾恩斯 饰）施加的压力下不情愿地操纵着卡勒姆·林奇回到过去寻找伊甸园苹果在现代世界的下落，威胁着他身体和心理的健康。但在杀手同行穆萨（迈克尔·威廉姆斯 饰）暗示了卡勒姆·林奇，提醒他艾伦有可能动机不纯之后，卡勒姆·林奇开始重新考虑他的行为和动机，而人类自由意志的命运也变得悬而未决……"},{"name":"评分","value":5.5},{"name":"image","value":"https://img5.doubanio.com/view/movie_poster_cover/lpst/public/p2432597986.jpg"},{"name":"id","value":"11526817"}]}
    ...
    var bar_stack_option = {
        ...
        series: [{
            ...
            type: 'line',
            yAxisIndex: 2,
            data: [12303,11720,12267,12176,11638,11931,12146,10113,12117,11411,11881,11697,12201,12026,12815,13015,12793,13391,13741,13720,13232,15135,15310,13944,13946,15111,15744,19097,23079,26445,26989,35934,50715,63751,74566,183032,213601,160348,83251,61332,51776]
        }, ]
    };
