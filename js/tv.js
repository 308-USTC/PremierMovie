var ia = [
    [
        ...
        [1, "三生三世十里桃花", "杨幂 赵又廷 张智尧 迪丽热巴 ", "中国大陆", "剧情 爱情", 9461269, "↑"],
        [2, "大唐荣耀", "景甜 任嘉伦 万茜 舒畅 ", "中国大陆", "剧情 爱情 古装", 2637142, "↓"],
        [3, "大秦帝国之崛起", "宁静 张博 邢佳栋 杨志刚 ", "中国大陆", "剧情 历史", 6010985, "↓"],
        [4, "射雕英雄传", "杨旭文 李一桐 陈星旭 孟子义 ", "中国大陆", "剧情 武侠 古装", 5144461, "↓"],
        [5, "半妖倾城", "张哲瀚 许晓诺 李一桐 米热 ", "中国大陆", "剧情 爱情 奇幻", 1208432, "↓"],
        [6, "奇星记之鲜衣怒马少年时", "吴磊 陈翔 郑合惠子 郝劭文 ", "中国大陆", "剧情 奇幻 古装", 1235960, "↑"],
        [7, "择天记", "鹿晗 娜扎 吴倩 曾舜晞 ", "中国大陆", "剧情 奇幻 古装", 7378605, "↑"],
        [8, "周末父母", "刘恺威 王鸥 张萌 朱泳腾 ", "中国大陆", "剧情 家庭", 3997797, "↑"],
        [9, "云巅之上", "陈晓 袁姗姗 张哲瀚 米热 ", "中国大陆", "剧情 爱情", 4917966, "↓"],
        [10, "大明王朝1566", "陈宝国 黄志忠 倪大红 王庆祥 ", "中国大陆", "剧情 历史", 9316006, "↑"]
    ],
    [
        ["排行", "片名", "上榜天数", "最高排名", "昨日新增", "走势"],
        [1, "三生三世十里桃花", "29天", "Top1", 4425377, "↑"],
        [2, "大唐荣耀", "1天", "Top1", 8360196, "↓"],
        [3, "大秦帝国之崛起", "38天", "Top2", 594601, "↑"],
        [4, "射雕英雄传", "16天", "Top3", 1816507, "↓"],
        [5, "半妖倾城", "29天", "Top2", 2872433, "↓"],
        [6, "奇星记之鲜衣怒马少年时", "76天", "Top3", 8855771, "↓"],
        [7, "奇星记之鲜衣怒马少年时", "10天", "Top5", 8354391, "↑"],
        [8, "择天记", "20天", "Top3", 4831369, "↑"],
        [9, "周末父母", "83天", "Top5", 5122611, "↑"],
        [10, "云巅之上", "29天", "Top2", 7247704, "↓"]
    ],
    [
        ["排行", "片名", "主演", "地区", "类型", "评分"],
        [1, "大明王朝1566", "陈宝国 黄志忠 倪大红 王庆祥 ", "中国大陆", "剧情 历史", 9.5],
        [2, "大明王朝1566", "陈宝国 黄志忠 倪大红 王庆祥 ", "中国大陆", "剧情 历史", 9.5],
        [3, "大秦帝国之崛起", "宁静 张博 邢佳栋 杨志刚 ", "中国大陆", "剧情 历史", 8.6],
        [4, "少年锦衣卫", "马正阳 丽阳 范哲琛 宝木中阳 ", "中国大陆", "动画 武侠", 8.7],
        [5, "鬼吹灯之精绝古城", "靳东 陈乔恩 赵达 岳旸 ", "中国大陆", "剧情 悬疑 惊悚", 8.2],
        [6, "射雕英雄传", "杨旭文 李一桐 陈星旭 孟子义 ", "中国大陆", "剧情 武侠 古装", 8.1],
        [7, "大唐荣耀", "景甜 任嘉伦 万茜 舒畅 ", "中国大陆", "剧情 爱情 古装", 7],
        [8, "三生三世十里桃花", "杨幂 赵又廷 张智尧 迪丽热巴 ", "中国大陆", "剧情 爱情", 6.3],
        [9, "云巅之上", "陈晓 袁姗姗 张哲瀚 米热 ", "中国大陆", "剧情 爱情", 6.3],
        [10, "热血长安", "徐海乔 鞠婧祎 程小蒙 刘冠麟 ", "中国大陆", "剧情 悬疑 古装", 6]
    ]
]
